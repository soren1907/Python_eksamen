...
#   for hver iteration ganges tallet med 2

#   klassen AddSelf laves med __init__ , __next__ og __iter__ - metode
#   Snyde note: husk return self i __iter__

#-----

#   *Bruger iter metode på klassen og sæt det til en variabel
#   Brug next til at komme med input

#-----

#   interate variabel med forloop

#-----

#   Samme eksempel laves nu med en generator function
#   ingen __iter__ , __next__ & stopIteration, men yield i stedet
#   forskel på yield og return
#   snyde-note: brug while loop
